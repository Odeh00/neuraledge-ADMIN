    ...
    <AuthGuard user={user}>
      <div className="admin-shell">
        ...
        <main className="admin-main">
          <div className="mobile-bar"><button className="icon-button" onClick={() => setMenuOpen(true)}>☰</button><strong>NeuralEdge Admin</strong><span className="role-pill">{user.role}</span></div>
